...
**Stars**: `99.2k` | **Created at**: `2023-01-17` | **Last updated**: `2026-01-07` | **Tags**: `Core`


The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
<details><summary>Included Nodes (579)</summary>
 ...
 - <sub>T5TokenizerOptions</sub>, <sub>TCFG</sub>, <sub>TemporalScoreRescaling</sub>, <sub>TestAccumulateNode</sub>, <sub>TestAccumulationGetItemNode</sub>, <sub>TestAccumulationGetLengthNode</sub>, <sub>TestAccumulationHeadNode</sub>, <sub>TestAccumulationSetItemNode</sub>, <sub>TestAccumulationTailNode</sub>, <sub>TestAccumulationToListNode</sub>, <sub>TestAsyncBatchProcessing</sub>, <sub>TestAsyncConcurrentLimit</sub>, <sub>TestAsyncError</sub>, <sub>TestAsyncLazyCheck</sub>, <sub>TestAsyncProgressUpdate</sub>, <sub>TestAsyncResourceUser</sub>, <sub>TestAsyncTimeout</sub>, <sub>TestAsyncValidation</sub>, <sub>TestAsyncValidationError</sub>, <sub>TestBoolOperationNode</sub>, <sub>TestCustomIsChanged</sub>, <sub>TestCustomValidation1</sub>, <sub>TestCustomValidation2</sub>, <sub>TestCustomValidation3</sub>, <sub>TestCustomValidation4</sub>, <sub>TestCustomValidation5</sub>, <sub>TestDynamicAsyncGeneration</sub>, <sub>TestDynamicDependencyCycle</sub>, <sub>TestExecutionBlocker</sub>, <sub>TestFloatConditions</sub>, <sub>TestForLoopClose</sub>, <sub>TestForLoopOpen</sub>, <sub>TestIntConditions</sub>, <sub>TestIntMathOperation</sub>, <sub>TestIsChangedWithConstants</sub>, <sub>TestLazyMixImages</sub>, <sub>TestListToAccumulationNode</sub>, <sub>TestMakeListNode</sub>, <sub>TestMixedExpansionReturns</sub>, <sub>TestOutputNodeWithSocketOutput</sub>, <sub>TestParallelSleep</sub>, <sub>TestSamplingInExpansion</sub>, <sub>TestSleep</sub>, <sub>TestStringConditions</sub>, <sub>TestSyncError</sub>, <sub>TestSyncProgressUpdate</sub>, <sub>TestToBoolNode</sub>, <sub>TestVariadicAverage</sub>, <sub>TestWhileLoopClose</sub>, <sub>TestWhileLoopOpen</sub>, <sub>TextEncodeAceStepAudio</sub>, <sub>TextEncodeHunyuanVideo_ImageToVideo</sub>, <sub>TextEncodeQwenImageEdit</sub>, <sub>TextEncodeQwenImageEditPlus</sub>, <sub>[ThresholdMask](node_examples/ThresholdMask.md)</sub>, <sub>[TomePatchModel](node_examples/TomePatchModel.md)</sub>, <sub>TopazImageEnhance</sub>, <sub>TopazVideoEnhance</sub>, <sub>TorchCompileModel</sub>, <sub>TrainLoraNode</sub>, <sub>TrimAudioDuration</sub>, <sub>TrimVideoLatent</sub>, <sub>[TripleCLIPLoader](node_examples/TripleCLIPLoader.md)</sub>, <sub>TripoConversionNode</sub>, <sub>TripoImageToModelNode</sub>, <sub>TripoMultiviewToModelNode</sub>, <sub>TripoRefineNode</sub>, <sub>TripoRetargetNode</sub>, <sub>TripoRigNode</sub>, <sub>TripoTextToModelNode</sub>, <sub>TripoTextureNode</sub>
...
**Stars**: `13.1k` | **Created at**: `2023-04-23` | **Last updated**: `2026-01-06`
...
**Stars**: `7.9k` | **Created at**: `2022-09-21` | **Last updated**: `2026-01-03` | **Tags**: `Integration`
...
**Stars**: `7.2k` | **Created at**: `2022-12-20` | **Last updated**: `2026-01-06` | **Tags**: `Integration`
...
**Stars**: `7.1k` | **Created at**: `2024-03-06` | **Last updated**: `2026-01-06` | **Tags**: `Workflow Examples` `Chinese Language`


我的 ComfyUI 工作流合集 | My ComfyUI workflows collection

## 7. kijai/ComfyUI-WanVideoWrapper
...
**Stars**: `5.8k` | **Created at**: `2025-02-25` | **Last updated**: `2026-01-06`
...
<details><summary>Included Nodes (146)</summary>
 ...
 - <sub>HuMoEmbeds</sub>
 - <sub>LandmarksToImage</sub>, <sub>LoadLynxResampler</sub>, <sub>LoadNLFModel</sub>, <sub>LoadVQVAE</sub>, <sub>LoadWanVideoClipTextEncoder</sub>, <sub>LoadWanVideoT5TextEncoder</sub>, <sub>LynxEncodeFaceIP</sub>, <sub>LynxInsightFaceCrop</sub>
...
## 8. cubiq/ComfyUI_IPAdapter_plus
...
**Stars**: `5.7k` | **Created at**: `2023-08-30` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `5.7k` | **Created at**: `2025-06-01` | **Last updated**: `2026-01-06`


The world's first open-source multimodal creative assistant  This is a substitute for Canva and Manus that prioritizes privacy and is usable locally.

## 10. ddean2009/MoneyPrinterPlus
...
**Stars**: `5.6k` | **Created at**: `2024-05-09` | **Last updated**: `2026-01-06`
...
<details><summary>Star History for TOP 11 - 15</summary><a href="https://api.star-history.com/svg?repos=AIDC-AI/ComfyUI-Copilot,comfyanonymous/ComfyUI_examples,Fannovel16/comfyui_controlnet_aux,MrForExample/ComfyUI-3D-Pack,nunchaku-tech/nunchaku&type=Date"><img src="https://api.star-history.com/svg?repos=AIDC-AI/ComfyUI-Copilot,comfyanonymous/ComfyUI_examples,Fannovel16/comfyui_controlnet_aux,MrForExample/ComfyUI-3D-Pack,nunchaku-tech/nunchaku&type=Date" alt="Star History Chart" width="500"></a></details>


## 11. AIDC-AI/ComfyUI-Copilot
...
**Stars**: `4.2k` | **Created at**: `2025-02-14` | **Last updated**: `2026-01-06`
...
**Stars**: `3.8k` | **Created at**: `2023-01-30` | **Last updated**: `2026-01-06` | **Tags**: `Workflow Examples`


Examples of ComfyUI workflows

## 13. Fannovel16/comfyui_controlnet_aux
...
**Stars**: `3.7k` | **Created at**: `2023-08-17` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 14. MrForExample/ComfyUI-3D-Pack
...
**Stars**: `3.6k` | **Created at**: `2024-01-05` | **Last updated**: `2026-01-05` | **Tags**: `Custom Nodes` `3D`
...
**Stars**: `3.6k` | **Created at**: `2024-11-06` | **Last updated**: `2026-01-06`


[ICLR2025 Spotlight] SVDQuant: Absorbing Outliers by Low-Rank Components for 4-Bit Diffusion Models
# TOP 16 - 20

<details><summary>Star History for TOP 16 - 20</summary><a href="https://api.star-history.com/svg?repos=mcmonkeyprojects/SwarmUI,Kosinkadink/ComfyUI-AnimateDiff-Evolved,city96/ComfyUI-GGUF,ltdrdata/ComfyUI-Impact-Pack,pythongosssss/ComfyUI-Custom-Scripts&type=Date"><img src="https://api.star-history.com/svg?repos=mcmonkeyprojects/SwarmUI,Kosinkadink/ComfyUI-AnimateDiff-Evolved,city96/ComfyUI-GGUF,ltdrdata/ComfyUI-Impact-Pack,pythongosssss/ComfyUI-Custom-Scripts&type=Date" alt="Star History Chart" width="500"></a></details>


## 16. mcmonkeyprojects/SwarmUI
...
**Stars**: `3.5k` | **Created at**: `2024-06-21` | **Last updated**: `2026-01-06` | **Tags**: `Integration`


SwarmUI (formerly StableSwarmUI), A Modular Stable Diffusion Web-User-Interface, with an emphasis on making powertools easily accessible, high performance, and extensibility.

## 17. Kosinkadink/ComfyUI-AnimateDiff-Evolved
...
**Stars**: `3.4k` | **Created at**: `2023-08-26` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `3.1k` | **Created at**: `2024-08-15` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 19. ltdrdata/ComfyUI-Impact-Pack
...
**Stars**: `2.9k` | **Created at**: `2023-03-30` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 20. pythongosssss/ComfyUI-Custom-Scripts
...
**Stars**: `2.9k` | **Created at**: `2023-03-06` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Management`
...
<details><summary>Star History for TOP 21 - 25</summary><a href="https://api.star-history.com/svg?repos=chflame163/ComfyUI_LayerStyle,nunchaku-tech/ComfyUI-nunchaku,FurkanGozukara/Stable-Diffusion,rgthree/rgthree-comfy,PowerHouseMan/ComfyUI-AdvancedLivePortrait&type=Date"><img src="https://api.star-history.com/svg?repos=chflame163/ComfyUI_LayerStyle,nunchaku-tech/ComfyUI-nunchaku,FurkanGozukara/Stable-Diffusion,rgthree/rgthree-comfy,PowerHouseMan/ComfyUI-AdvancedLivePortrait&type=Date" alt="Star History Chart" width="500"></a></details>


## 21. chflame163/ComfyUI_LayerStyle
...
**Stars**: `2.7k` | **Created at**: `2025-03-12` | **Last updated**: `2026-01-06`


ComfyUI Plugin of Nunchaku
<details><summary>Included Nodes (16)</summary>

 - <sub>NunchakuDepthPreprocessor</sub>, <sub>NunchakuFluxDiTLoader</sub>, <sub>NunchakuFluxIPAdapterApply</sub>, <sub>NunchakuFluxLoraLoader</sub>, <sub>NunchakuFluxLoraStack</sub>, <sub>NunchakuFluxPuLIDApplyV2</sub>, <sub>NunchakuIPAdapterLoader</sub>, <sub>NunchakuModelMerger</sub>, <sub>NunchakuPulidApply</sub>, <sub>NunchakuPulidLoader</sub>, <sub>NunchakuPuLIDLoaderV2</sub>, <sub>NunchakuQwenImageDiTLoader</sub>, <sub>NunchakuTextEncoderLoader</sub>, <sub>NunchakuTextEncoderLoaderV2</sub>, <sub>NunchakuWheelInstaller</sub>, <sub>NunchakuZImageDiTLoader</sub>
</details>


## 23. FurkanGozukara/Stable-Diffusion
...
**Stars**: `2.6k` | **Created at**: `2023-05-01` | **Last updated**: `2026-01-06` | **Tags**: `Tutorials`
...
**Stars**: `2.6k` | **Created at**: `2023-08-14` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `2.6k` | **Created at**: `2024-07-31` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Video`
...
<details><summary>Star History for TOP 26 - 30</summary><a href="https://api.star-history.com/svg?repos=kijai/ComfyUI-HunyuanVideoWrapper,Lightricks/ComfyUI-LTXVideo,AIGODLIKE/AIGODLIKE-ComfyUI-Translation,6174/comflowyspace,yolain/ComfyUI-Easy-Use&type=Date"><img src="https://api.star-history.com/svg?repos=kijai/ComfyUI-HunyuanVideoWrapper,Lightricks/ComfyUI-LTXVideo,AIGODLIKE/AIGODLIKE-ComfyUI-Translation,6174/comflowyspace,yolain/ComfyUI-Easy-Use&type=Date" alt="Star History Chart" width="500"></a></details>


## 26. kijai/ComfyUI-HunyuanVideoWrapper
...
**Stars**: `2.6k` | **Created at**: `2024-12-03` | **Last updated**: `2026-01-06`
...
## 27. Lightricks/ComfyUI-LTXVideo
...
**Stars**: `2.5k` | **Created at**: `2024-11-21` | **Last updated**: `2026-01-07`


LTX-Video Support for ComfyUI
<details><summary>Included Nodes (53)</summary>

 - <sub>AddLatentGuide</sub>
 - <sub>DynamicConditioning</sub>
 - <sub>GuiderParameters</sub>
 - <sub>ImageToCPU</sub>
 - <sub>LowVRAMAudioVAELoader</sub>, <sub>LowVRAMCheckpointLoader</sub>, <sub>LowVRAMLatentUpscaleModelLoader</sub>, <sub>LTXAddImageGuide</sub>, <sub>LTXAttentionBank</sub>, <sub>LTXAttentioOverride</sub>, <sub>LTXAttnOverride</sub>, <sub>LTXFetaEnhance</sub>, <sub>LTXFlowEditCFGGuider</sub>, <sub>LTXFlowEditSampler</sub>, <sub>LTXForwardModelSamplingPred</sub>, <sub>LTXPerturbedAttention</sub>, <sub>LTXPrepareAttnInjections</sub>, <sub>LTXQ8Patch</sub>, <sub>LTXReverseModelSamplingPred</sub>, <sub>LTXRFForwardODESampler</sub>, <sub>LTXRFReverseODESampler</sub>, <sub>LTXVAdainLatent</sub>, <sub>LTXVAddGuideAdvanced</sub>, <sub>LTXVAddLatentGuide</sub>, <sub>LTXVApplySTG</sub>, <sub>LTXVBaseSampler</sub>, <sub>LTXVExtendSampler</sub>, <sub>LTXVGemmaCLIPModelLoader</sub>, <sub>LTXVGemmaCLIPModelLoaderMGPU</sub>, <sub>LTXVGemmaEnhancePrompt</sub>, <sub>LTXVImgToVideoConditionOnly</sub>, <sub>LTXVInContextSampler</sub>, <sub>LTXVLinearOverlapLatentTransition</sub>, <sub>LTXVLoopingSampler</sub>, <sub>LTXVMultiPromptProvider</sub>, <sub>LTXVPatcherVAE</sub>, <sub>LTXVPerStepAdainPatcher</sub>, <sub>LTXVPerStepStatNormPatcher</sub>, <sub>LTXVPreprocessMasks</sub>, <sub>LTXVPromptEnhancer</sub>, <sub>LTXVPromptEnhancerLoader</sub>, <sub>LTXVQ8LoraModelLoader</sub>, <sub>LTXVSelectLatents</sub>, <sub>LTXVSetVideoLatentNoiseMasks</sub>, <sub>LTXVStatNormLatent</sub>, <sub>LTXVTiledSampler</sub>, <sub>LTXVTiledVAEDecode</sub>
...
**Stars**: `2.4k` | **Created at**: `2023-08-15` | **Last updated**: `2026-01-04` | **Tags**: `Translation`


A plugin for multilingual translation of ComfyUI，This plugin implements translation of resident menu bar/search bar/right-click context menu/node, etc

## 29. 6174/comflowyspace
...
**Stars**: `2.4k` | **Created at**: `2023-11-25` | **Last updated**: `2026-01-06` | **Tags**: `Integration`
...
**Stars**: `2.2k` | **Created at**: `2023-12-10` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Chinese Language`
...
<details><summary>Star History for TOP 31 - 35</summary><a href="https://api.star-history.com/svg?repos=kijai/ComfyUI-SUPIR,pydn/ComfyUI-to-Python-Extension,kijai/ComfyUI-KJNodes,kijai/ComfyUI-LivePortraitKJ,heshengtao/comfyui_LLM_party&type=Date"><img src="https://api.star-history.com/svg?repos=kijai/ComfyUI-SUPIR,pydn/ComfyUI-to-Python-Extension,kijai/ComfyUI-KJNodes,kijai/ComfyUI-LivePortraitKJ,heshengtao/comfyui_LLM_party&type=Date" alt="Star History Chart" width="500"></a></details>


## 31. kijai/ComfyUI-SUPIR
...
**Stars**: `2.2k` | **Created at**: `2024-02-28` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 32. pydn/ComfyUI-to-Python-Extension
...
**Stars**: `2.2k` | **Created at**: `2023-07-30` | **Last updated**: `2026-01-06` | **Tags**: `Integration`


A powerful tool that translates ComfyUI workflows into executable Python code.

## 33. kijai/ComfyUI-KJNodes
...
**Stars**: `2.2k` | **Created at**: `2023-09-28` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
<details><summary>Included Nodes (206)</summary>
 ...
 - <sub>VAEDecodeLoopKJ</sub>, <sub>VAELoaderKJ</sub>, <sub>VisualizeCUDAMemoryHistory</sub>, <sub>[VRAM_Debug](node_examples/VRAM_Debug.md)</sub>
 - <sub>Wan21BlockLoraSelect</sub>, <sub>WanImageToVideoSVIPro</sub>, <sub>WanVideoEnhanceAVideoKJ</sub>, <sub>WanVideoNAG</sub>, <sub>WanVideoTeaCacheKJ</sub>, <sub>WebcamCaptureCV2</sub>, <sub>[WeightScheduleConvert](node_examples/WeightScheduleConvert.md)</sub>, <sub>WeightScheduleExtend</sub>, <sub>WidgetToString</sub>
</details>


## 34. kijai/ComfyUI-LivePortraitKJ
...
**Stars**: `2.1k` | **Created at**: `2024-07-04` | **Last updated**: `2026-01-03`
...
## 35. heshengtao/comfyui_LLM_party
...
**Stars**: `2.1k` | **Created at**: `2024-04-13` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `LLM`
...
<details><summary>Star History for TOP 36 - 40</summary><a href="https://api.star-history.com/svg?repos=mut-ex/gligen-gui,Comfy-Org/desktop,siliconflow/onediff,zombieyang/sd-ppp,yolain/ComfyUI-Yolain-Workflows&type=Date"><img src="https://api.star-history.com/svg?repos=mut-ex/gligen-gui,Comfy-Org/desktop,siliconflow/onediff,zombieyang/sd-ppp,yolain/ComfyUI-Yolain-Workflows&type=Date" alt="Star History Chart" width="500"></a></details>


## 36. mut-ex/gligen-gui
...
**Stars**: `2.0k` | **Created at**: `2024-02-17` | **Last updated**: `2026-01-06` | **Tags**: `Integration`


An intuitive GUI for GLIGEN that uses ComfyUI in the backend

## 37. Comfy-Org/desktop
...
**Stars**: `2.0k` | **Created at**: `2024-08-13` | **Last updated**: `2026-01-06`


The desktop app for ComfyUI (Windows & macOS)

## 38. siliconflow/onediff
...
**Stars**: `2.0k` | **Created at**: `2022-09-21` | **Last updated**: `2026-01-06` | **Tags**: `Acceleration`


OneDiff: An out-of-the-box acceleration library for diffusion models.

## 39. zombieyang/sd-ppp
...
**Stars**: `1.9k` | **Created at**: `2024-03-29` | **Last updated**: `2026-01-06`
...
## 40. yolain/ComfyUI-Yolain-Workflows
...
**Stars**: `1.8k` | **Created at**: `2024-05-13` | **Last updated**: `2026-01-05` | **Tags**: `Workflow Examples`


Some awesome comfyui workflows in here, and they are built using the comfyui-easy-use node package.
# TOP 41 - 45

<details><summary>Star History for TOP 41 - 45</summary><a href="https://api.star-history.com/svg?repos=ZHO-ZHO-ZHO/comfyui-portrait-master-zh-cn,MixLabPro/comfyui-mixlab-nodes,cubiq/ComfyUI_InstantID,numz/ComfyUI-SeedVR2_VideoUpscaler,huchenlei/ComfyUI-layerdiffuse&type=Date"><img src="https://api.star-history.com/svg?repos=ZHO-ZHO-ZHO/comfyui-portrait-master-zh-cn,MixLabPro/comfyui-mixlab-nodes,cubiq/ComfyUI_InstantID,numz/ComfyUI-SeedVR2_VideoUpscaler,huchenlei/ComfyUI-layerdiffuse&type=Date" alt="Star History Chart" width="500"></a></details>


## 41. ZHO-ZHO-ZHO/comfyui-portrait-master-zh-cn
...
**Stars**: `1.8k` | **Created at**: `2023-12-15` | **Last updated**: `2026-01-03` | **Tags**: `Custom Nodes` `Chinese Language`
...
## 42. MixLabPro/comfyui-mixlab-nodes
...
**Stars**: `1.8k` | **Created at**: `2023-10-18` | **Last updated**: `2026-01-06`


Workflow-to-APP、ScreenShare&FloatingVideo、GPT & 3D、SpeechRecognition&TTS

## 43. cubiq/ComfyUI_InstantID
...
**Stars**: `1.8k` | **Created at**: `2024-01-27` | **Last updated**: `2026-01-05` | **Tags**: `Custom Nodes`
...
## 44. numz/ComfyUI-SeedVR2_VideoUpscaler
...
**Stars**: `1.8k` | **Created at**: `2025-06-20` | **Last updated**: `2026-01-06`
...
## 45. huchenlei/ComfyUI-layerdiffuse
...
**Stars**: `1.8k` | **Created at**: `2024-03-02` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
<details><summary>Star History for TOP 46 - 50</summary><a href="https://api.star-history.com/svg?repos=WASasquatch/was-node-suite-comfyui,crystian/ComfyUI-Crystools,XLabs-AI/x-flux-comfyui,1038lab/ComfyUI-RMBG,kijai/ComfyUI-FramePackWrapper&type=Date"><img src="https://api.star-history.com/svg?repos=WASasquatch/was-node-suite-comfyui,crystian/ComfyUI-Crystools,XLabs-AI/x-flux-comfyui,1038lab/ComfyUI-RMBG,kijai/ComfyUI-FramePackWrapper&type=Date" alt="Star History Chart" width="500"></a></details>


## 46. WASasquatch/was-node-suite-comfyui
...
**Stars**: `1.7k` | **Created at**: `2023-03-24` | **Last updated**: `2026-01-05` | **Tags**: `Custom Nodes`


An extensive node suite for ComfyUI with over 210 new nodes

## 47. crystian/ComfyUI-Crystools
...
**Stars**: `1.7k` | **Created at**: `2023-12-23` | **Last updated**: `2026-01-06` | **Tags**: `Management`
...
**Stars**: `1.7k` | **Created at**: `2024-08-12` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.6k` | **Created at**: `2024-11-14` | **Last updated**: `2026-01-06`
...
## 50. kijai/ComfyUI-FramePackWrapper
...
**Stars**: `1.6k` | **Created at**: `2025-04-17` | **Last updated**: `2026-01-06`


None
# TOP 51 - 55

<details><summary>Star History for TOP 51 - 55</summary><a href="https://api.star-history.com/svg?repos=Comfy-Org/ComfyUI_frontend,kijai/ComfyUI-Florence2,kijai/ComfyUI-CogVideoXWrapper,16131zzzzzzzz/EveryoneNobel,heshengtao/super-agent-party&type=Date"><img src="https://api.star-history.com/svg?repos=Comfy-Org/ComfyUI_frontend,kijai/ComfyUI-Florence2,kijai/ComfyUI-CogVideoXWrapper,16131zzzzzzzz/EveryoneNobel,heshengtao/super-agent-party&type=Date" alt="Star History Chart" width="500"></a></details>


## 51. Comfy-Org/ComfyUI_frontend
...
**Stars**: `1.6k` | **Created at**: `2024-06-13` | **Last updated**: `2026-01-06` | **Tags**: `Core`


Official front-end implementation of ComfyUI

## 52. kijai/ComfyUI-Florence2
...
**Stars**: `1.6k` | **Created at**: `2024-06-19` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 53. kijai/ComfyUI-CogVideoXWrapper
...
**Stars**: `1.5k` | **Created at**: `2024-08-05` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.5k` | **Created at**: `2024-10-20` | **Last updated**: `2026-01-05`


A flexible framework powered by ComfyUI for generating personalized Nobel Prize images.

## 55. heshengtao/super-agent-party
...
**Stars**: `1.5k` | **Created at**: `2025-03-08` | **Last updated**: `2026-01-06`
...
<details><summary>Star History for TOP 56 - 60</summary><a href="https://api.star-history.com/svg?repos=zhulu111/ComfyUI_Bxb,BennyKok/comfyui-deploy,ZHO-ZHO-ZHO/ComfyUI-InstantID,NimaNzrii/comfyui-photoshop,AlekPet/ComfyUI_Custom_Nodes_AlekPet&type=Date"><img src="https://api.star-history.com/svg?repos=zhulu111/ComfyUI_Bxb,BennyKok/comfyui-deploy,ZHO-ZHO-ZHO/ComfyUI-InstantID,NimaNzrii/comfyui-photoshop,AlekPet/ComfyUI_Custom_Nodes_AlekPet&type=Date" alt="Star History Chart" width="500"></a></details>


## 56. zhulu111/ComfyUI_Bxb
...
**Stars**: `1.5k` | **Created at**: `2024-05-18` | **Last updated**: `2026-01-06`
...
**Stars**: `1.5k` | **Created at**: `2023-12-08` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Integration`
...
## 58. ZHO-ZHO-ZHO/ComfyUI-InstantID
...
**Stars**: `1.4k` | **Created at**: `2024-01-22` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Chinese Language`
...
## 59. NimaNzrii/comfyui-photoshop
...
**Stars**: `1.4k` | **Created at**: `2023-12-09` | **Last updated**: `2026-01-05` | **Tags**: `Integration`
...
## 60. AlekPet/ComfyUI_Custom_Nodes_AlekPet
...
**Stars**: `1.4k` | **Created at**: `2023-05-10` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`


Custom nodes that extend the capabilities of Comfyui
# TOP 61 - 65

<details><summary>Star History for TOP 61 - 65</summary><a href="https://api.star-history.com/svg?repos=Kosinkadink/ComfyUI-VideoHelperSuite,11cafe/comfyui-workspace-manager,jags111/efficiency-nodes-comfyui,ssitu/ComfyUI_UltimateSDUpscale,logtd/ComfyUI-Fluxtapoz&type=Date"><img src="https://api.star-history.com/svg?repos=Kosinkadink/ComfyUI-VideoHelperSuite,11cafe/comfyui-workspace-manager,jags111/efficiency-nodes-comfyui,ssitu/ComfyUI_UltimateSDUpscale,logtd/ComfyUI-Fluxtapoz&type=Date" alt="Star History Chart" width="500"></a></details>


## 61. Kosinkadink/ComfyUI-VideoHelperSuite
...
**Stars**: `1.4k` | **Created at**: `2023-09-23` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Video`
...
## 62. 11cafe/comfyui-workspace-manager
...
**Stars**: `1.4k` | **Created at**: `2023-12-02` | **Last updated**: `2026-01-04` | **Tags**: `Management`
...
**Stars**: `1.4k` | **Created at**: `2023-08-31` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 64. ssitu/ComfyUI_UltimateSDUpscale
...
**Stars**: `1.4k` | **Created at**: `2023-05-16` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.4k` | **Created at**: `2024-08-15` | **Last updated**: `2026-01-06`
...
<details><summary>Star History for TOP 66 - 70</summary><a href="https://api.star-history.com/svg?repos=AIGODLIKE/ComfyUI-BlenderAI-node,fofr/cog-face-to-many,YanWenKun/ComfyUI-Docker,nerdyrodent/AVeryComfyNerd,Enemyx-net/VibeVoice-ComfyUI&type=Date"><img src="https://api.star-history.com/svg?repos=AIGODLIKE/ComfyUI-BlenderAI-node,fofr/cog-face-to-many,YanWenKun/ComfyUI-Docker,nerdyrodent/AVeryComfyNerd,Enemyx-net/VibeVoice-ComfyUI&type=Date" alt="Star History Chart" width="500"></a></details>


## 66. AIGODLIKE/ComfyUI-BlenderAI-node
...
**Stars**: `1.4k` | **Created at**: `2024-03-05` | **Last updated**: `2025-12-30` | **Tags**: `Workflow Examples`


Turn any face into a video game character, pixel art, claymation, 3D or toy

## 68. YanWenKun/ComfyUI-Docker
...
**Stars**: `1.3k` | **Created at**: `2023-03-17` | **Last updated**: `2026-01-06`


🐳Dockerfile for 🎨ComfyUI. | 容器镜像与启动脚本

## 69. nerdyrodent/AVeryComfyNerd
...
**Stars**: `1.3k` | **Created at**: `2023-08-17` | **Last updated**: `2026-01-06` | **Tags**: `Resources`


ComfyUI related stuff and things

## 70. Enemyx-net/VibeVoice-ComfyUI
...
**Stars**: `1.3k` | **Created at**: `2025-08-27` | **Last updated**: `2026-01-06`
...
<details><summary>Star History for TOP 71 - 75</summary><a href="https://api.star-history.com/svg?repos=yawiii/ComfyUI-Prompt-Assistant,zanllp/sd-webui-infinite-image-browsing,mcmonkeyprojects/sd-dynamic-thresholding,chengzeyi/Comfy-WaveSpeed,6174/comflowy&type=Date"><img src="https://api.star-history.com/svg?repos=yawiii/ComfyUI-Prompt-Assistant,zanllp/sd-webui-infinite-image-browsing,mcmonkeyprojects/sd-dynamic-thresholding,chengzeyi/Comfy-WaveSpeed,6174/comflowy&type=Date" alt="Star History Chart" width="500"></a></details>


## 71. yawiii/ComfyUI-Prompt-Assistant
...
**Stars**: `1.3k` | **Created at**: `2025-06-06` | **Last updated**: `2026-01-06`
...
## 72. zanllp/sd-webui-infinite-image-browsing
...
**Stars**: `1.2k` | **Created at**: `2023-03-07` | **Last updated**: `2026-01-06` | **Tags**: `Management`


A fast and powerful image/video/audio browser for SD-webui / ComfyUI / Fooocus / NovelAI / StableSwarmUI, featuring infinite scrolling and advanced search capabilities using image parameters. It also supports standalone operation.

## 73. mcmonkeyprojects/sd-dynamic-thresholding
...
**Stars**: `1.2k` | **Created at**: `2023-01-27` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.2k` | **Created at**: `2024-11-27` | **Last updated**: `2026-01-06`
...
**Stars**: `1.2k` | **Created at**: `2023-11-20` | **Last updated**: `2025-12-25` | **Tags**: `Website`


Unleash endless possibilities with ComfyUI and Stable Diffusion, committed to crafting refined AI-Gen tools and cultivating a vibrant community for both developers and users. 
# TOP 76 - 80

<details><summary>Star History for TOP 76 - 80</summary><a href="https://api.star-history.com/svg?repos=florestefano1975/comfyui-portrait-master,kijai/ComfyUI-segment-anything-2,Suzie1/ComfyUI_Comfyroll_CustomNodes,kijai/ComfyUI-IC-Light,wyrde/wyrde-comfyui-workflows&type=Date"><img src="https://api.star-history.com/svg?repos=florestefano1975/comfyui-portrait-master,kijai/ComfyUI-segment-anything-2,Suzie1/ComfyUI_Comfyroll_CustomNodes,kijai/ComfyUI-IC-Light,wyrde/wyrde-comfyui-workflows&type=Date" alt="Star History Chart" width="500"></a></details>


## 76. florestefano1975/comfyui-portrait-master
...
**Stars**: `1.2k` | **Created at**: `2023-12-13` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.1k` | **Created at**: `2024-07-30` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 78. Suzie1/ComfyUI_Comfyroll_CustomNodes
...
**Stars**: `1.1k` | **Created at**: `2023-06-10` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.1k` | **Created at**: `2024-05-09` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
## 80. wyrde/wyrde-comfyui-workflows
...
**Stars**: `1.1k` | **Created at**: `2023-04-03` | **Last updated**: `2026-01-06` | **Tags**: `Workflow Examples`


some wyrde workflows for comfyUI
# TOP 81 - 85

<details><summary>Star History for TOP 81 - 85</summary><a href="https://api.star-history.com/svg?repos=smthemex/ComfyUI_Sonic,Acly/comfyui-inpaint-nodes,kijai/ComfyUI-FluxTrainer,AIDC-AI/Pixelle-Video,pythongosssss/ComfyUI-WD14-Tagger&type=Date"><img src="https://api.star-history.com/svg?repos=smthemex/ComfyUI_Sonic,Acly/comfyui-inpaint-nodes,kijai/ComfyUI-FluxTrainer,AIDC-AI/Pixelle-Video,pythongosssss/ComfyUI-WD14-Tagger&type=Date" alt="Star History Chart" width="500"></a></details>


## 81. smthemex/ComfyUI_Sonic
...
**Stars**: `1.1k` | **Created at**: `2025-02-07` | **Last updated**: `2025-12-30`
...
**Stars**: `1.1k` | **Created at**: `2024-01-24` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.1k` | **Created at**: `2024-08-15` | **Last updated**: `2026-01-06`
...
**Stars**: `1.1k` | **Created at**: `2025-11-07` | **Last updated**: `2026-01-06`


🚀 AI 全自动短视频引擎 | AI Fully Automated Short Video Engine

## 85. pythongosssss/ComfyUI-WD14-Tagger
...
**Stars**: `1.1k` | **Created at**: `2023-05-11` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
<details><summary>Star History for TOP 86 - 90</summary><a href="https://api.star-history.com/svg?repos=storyicon/comfyui_segment_anything,602387193c/ComfyUI-wiki,welltop-cn/ComfyUI-TeaCache,cubiq/ComfyUI_essentials,Gourieff/ComfyUI-ReActor&type=Date"><img src="https://api.star-history.com/svg?repos=storyicon/comfyui_segment_anything,602387193c/ComfyUI-wiki,welltop-cn/ComfyUI-TeaCache,cubiq/ComfyUI_essentials,Gourieff/ComfyUI-ReActor&type=Date" alt="Star History Chart" width="500"></a></details>


## 86. storyicon/comfyui_segment_anything
...
**Stars**: `1.1k` | **Created at**: `2023-10-07` | **Last updated**: `2026-01-03` | **Tags**: `Custom Nodes`
...
**Stars**: `1.1k` | **Created at**: `2024-03-18` | **Last updated**: `2026-01-05` | **Tags**: `Resources`
...
## 88. welltop-cn/ComfyUI-TeaCache
...
**Stars**: `1.0k` | **Created at**: `2025-01-07` | **Last updated**: `2026-01-06`
...
**Stars**: `1.0k` | **Created at**: `2023-09-20` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `1.0k` | **Created at**: `2025-01-17` | **Last updated**: `2026-01-07`
...
<details><summary>Star History for TOP 91 - 95</summary><a href="https://api.star-history.com/svg?repos=ai-dock/comfyui,banodoco/Steerable-Motion,nullquant/ComfyUI-BrushNet,kijai/ComfyUI-Hunyuan3DWrapper,lquesada/ComfyUI-Inpaint-CropAndStitch&type=Date"><img src="https://api.star-history.com/svg?repos=ai-dock/comfyui,banodoco/Steerable-Motion,nullquant/ComfyUI-BrushNet,kijai/ComfyUI-Hunyuan3DWrapper,lquesada/ComfyUI-Inpaint-CropAndStitch&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `989` | **Created at**: `2023-08-22` | **Last updated**: `2026-01-06` | **Tags**: `Integration`


ComfyUI docker images for use in GPU cloud and local environments. Includes AI-Dock base for authentication and improved user experience. 

## 92. banodoco/Steerable-Motion
...
**Stars**: `960` | **Created at**: `2023-11-11` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes` `Video`


A ComfyUI node for driving videos using batches of images.

## 93. nullquant/ComfyUI-BrushNet
...
**Stars**: `935` | **Created at**: `2024-04-11` | **Last updated**: `2026-01-06` | **Tags**: `Custom Nodes`
...
**Stars**: `934` | **Created at**: `2025-01-21` | **Last updated**: `2026-01-06`


None

## 95. lquesada/ComfyUI-Inpaint-CropAndStitch
...
**Stars**: `931` | **Created at**: `2024-05-11` | **Last updated**: `2026-01-06`
...
<details><summary>Star History for TOP 96 - 100</summary><a href="https://api.star-history.com/svg?repos=Fannovel16/ComfyUI-Frame-Interpolation,Kosinkadink/ComfyUI-Advanced-ControlNet,ShmuelRonen/ComfyUI-LatentSyncWrapper,Jonseed/ComfyUI-Detail-Daemon,twri/sdxl_prompt_styler&type=Date"><img src="https://api.star-history.com/svg?repos=Fannovel16/ComfyUI-Frame-Interpolation,Kosinkadink/ComfyUI-Advanced-ControlNet,ShmuelRonen/ComfyUI-LatentSyncWrapper,Jonseed/ComfyUI-Detail-Daemon,twri/sdxl_prompt_styler&type=Date" alt="Star History Chart" width="500"></a></details>


## 96. Fannovel16/ComfyUI-Frame-Interpolation
...
**Stars**: `930` | **Created at**: `2023-07-31` | **Last updated**: `2026-01-05` | **Tags**: `Custom Nodes` `Video`
...
## 97. Kosinkadink/ComfyUI-Advanced-ControlNet
...
## 98. ShmuelRonen/ComfyUI-LatentSyncWrapper
...
**Stars**: `924` | **Created at**: `2025-01-01` | **Last updated**: `2026-01-04`
...
## 99. Jonseed/ComfyUI-Detail-Daemon
...
**Stars**: `910` | **Created at**: `2024-10-25` | **Last updated**: `2026-01-06`
...
**Stars**: `906` | **Created at**: `2023-07-22` | **Last updated**: `2026-01-02` | **Tags**: `Custom Nodes`
...
### Automatically updated on: 2026-01-07 00:29:25 UTC
