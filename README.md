...
- [Workflow Examples](tags/WorkflowExamples.md) (5)
- [Management](tags/Management.md) (3)
- [3D](tags/3D.md) (2)
- [Video](tags/Video.md) (2)
...
- [Chinese Language](tags/ChineseLanguage.md) (4)
...
**Stars**: `132.6k` | **Created at**: `2023-01-17` | **Last updated**: `2026-09-12`
...
**Stars**: `28.0k` | **Created at**: `2025-11-07` | **Last updated**: `2026-09-12`


🚀 AI 全自动短视频引擎 | AI Fully Automated Short Video Engine

## 3. Comfy-Org/ComfyUI-Manager
...
**Stars**: `16.1k` | **Created at**: `2023-04-23` | **Last updated**: `2026-09-12`


ComfyUI-Manager is an extension designed to enhance the usability of ComfyUI. It offers management functions to install, remove, disable, and enable various custom nodes of ComfyUI. Furthermore, this extension provides a hub feature and convenience functions to access a wide range of information within ComfyUI.

## 4. LykosAI/StabilityMatrix
...
**Stars**: `8.8k` | **Created at**: `2023-06-13` | **Last updated**: `2026-09-12` | **Tags**: `Integration`


Multi-Platform Package Manager for Stable Diffusion

## 5. TheLastBen/fast-stable-diffusion
...
**Stars**: `7.9k` | **Created at**: `2022-09-21` | **Last updated**: `2026-09-09` | **Tags**: `Integration`
...
**Stars**: `7.8k` | **Created at**: `2024-03-06` | **Last updated**: `2026-09-12` | **Tags**: `Workflow Examples` `Chinese Language`


我的 ComfyUI 工作流合集 | My ComfyUI workflows collection

## 7. AbdullahAlfaraj/Auto-Photoshop-StableDiffusion-Plugin
...
**Stars**: `7.3k` | **Created at**: `2022-12-20` | **Last updated**: `2026-09-09` | **Tags**: `Integration`
...
**Stars**: `7.1k` | **Created at**: `2024-05-09` | **Last updated**: `2026-09-11`
...
**Stars**: `6.7k` | **Created at**: `2025-02-25` | **Last updated**: `2026-09-11`


None
<details><summary>Included Nodes (148)</summary>
 ...
 - <sub>HuMoEmbeds</sub>
 - <sub>LandmarksToImage</sub>, <sub>LoadLynxResampler</sub>, <sub>LoadNLFModel</sub>, <sub>LoadVQVAE</sub>, <sub>LoadWanVideoClipTextEncoder</sub>, <sub>LoadWanVideoT5TextEncoder</sub>, <sub>LongCatAvatarWhisperEmbeds</sub>, <sub>LynxEncodeFaceIP</sub>, <sub>LynxInsightFaceCrop</sub>
 - <sub>MochaEmbeds</sub>, <sub>MTVCrafterEncodePoses</sub>, <sub>MultiTalkModelLoader</sub>, <sub>MultiTalkSilentEmbeds</sub>, <sub>MultiTalkWav2VecEmbeds</sub>
 - <sub>NLFPredict</sub>, <sub>NormalizeAudioLoudness</sub>
 - <sub>OviMMAudioVAELoader</sub>
 - <sub>QwenLoader</sub>
 - <sub>ReCamMasterPoseVisualizer</sub>
 - <sub>TextImageEncodeQwenVL</sub>
 - <sub>WanMove_native</sub>, <sub>WanVideoAddBindweaveEmbeds</sub>, <sub>WanVideoAddControlEmbeds</sub>, <sub>WanVideoAddDualControlEmbeds</sub>, <sub>WanVideoAddExtraLatent</sub>, <sub>WanVideoAddFantasyPortrait</sub>, <sub>WanVideoAddFlashVSRInput</sub>, <sub>WanVideoAddLucyEditLatents</sub>, <sub>WanVideoAddLynxEmbeds</sub>, <sub>WanVideoAddMTVMotion</sub>, <sub>WanVideoAddOneToAllExtendEmbeds</sub>, <sub>WanVideoAddOneToAllPoseEmbeds</sub>, <sub>WanVideoAddOneToAllReferenceEmbeds</sub>, <sub>WanVideoAddOviAudioToLatents</sub>, <sub>WanVideoAddPusaNoise</sub>, <sub>WanVideoAddS2VEmbeds</sub>, <sub>WanVideoAddSCAILPoseEmbeds</sub>, <sub>WanVideoAddSCAILReferenceEmbeds</sub>, <sub>WanVideoAddStandInLatent</sub>, <sub>WanVideoAddSteadyDancerEmbeds</sub>, <sub>WanVideoAddStoryMemLatents</sub>, <sub>WanVideoAddTTMLatents</sub>, <sub>WanVideoAddWanMoveTracks</sub>, <sub>WanVideoAnimateEmbeds</sub>, <sub>WanVideoApplyNAG</sub>, <sub>WanVideoATI_comfy</sub>, <sub>WanVideoATITracks</sub>, <sub>WanVideoATITracksVisualize</sub>, <sub>WanVideoBlockList</sub>, <sub>WanVideoBlockSwap</sub>, <sub>WanVideoClipVisionEncode</sub>, <sub>WanVideoCombineEmbeds</sub>, <sub>WanVideoContextOptions</sub>, <sub>WanVideoControlEmbeds</sub>, <sub>WanVideoControlnet</sub>, <sub>WanVideoControlnetLoader</sub>, <sub>WanVideoDecode</sub>, <sub>WanVideoDecodeOviAudio</sub>, <sub>WanVideoDiffusionForcingSampler</sub>, <sub>WanVideoEasyCache</sub>, <sub>WanVideoEmptyEmbeds</sub>, <sub>WanVideoEmptyMMAudioLatents</sub>, <sub>WanVideoEncode</sub>, <sub>WanVideoEncodeLatentBatch</sub>, <sub>WanVideoEncodeOviAudio</sub>, <sub>WanVideoEnhanceAVideo</sub>, <sub>WanVideoExperimentalArgs</sub>, <sub>WanVideoExtraModelSelect</sub>, <sub>WanVideoFlashVSRDecoderLoader</sub>, <sub>WanVideoFreeInitArgs</sub>, <sub>WanVideoFunCameraEmbeds</sub>, <sub>WanVideoImageClipEncode</sub>, <sub>WanVideoImageResizeToClosest</sub>, <sub>WanVideoImageToVideoEncode</sub>, <sub>WanVideoImageToVideoMultiTalk</sub>, <sub>WanVideoImageToVideoSkyreelsv3_audio</sub>, <sub>WanVideoLatentReScale</sub>, <sub>WanVideoLongCatAvatarExtendEmbeds</sub>, <sub>WanVideoLoopArgs</sub>, <sub>WanVideoLoraBlockEdit</sub>, <sub>WanVideoLoraSelect</sub>, <sub>WanVideoLoraSelectByName</sub>, <sub>WanVideoLoraSelectMulti</sub>, <sub>WanVideoMagCache</sub>, <sub>WanVideoMiniMaxRemoverEmbeds</sub>, <sub>WanVideoModelLoader</sub>, <sub>WanVideoOviCFG</sub>, <sub>WanVideoPassImagesFromSamples</sub>, <sub>WanVideoPhantomEmbeds</sub>, <sub>WanVideoPreviewEmbeds</sub>, <sub>WanVideoPromptExtender</sub>, <sub>WanVideoPromptExtenderSelect</sub>, <sub>WanVideoRealisDanceLatents</sub>, <sub>WanVideoReCamMasterCameraEmbed</sub>, <sub>WanVideoReCamMasterDefaultCamera</sub>, <sub>WanVideoReCamMasterGenerateOrbitCamera</sub>, <sub>WanVideoRoPEFunction</sub>, <sub>WanVideoSampler</sub>, <sub>WanVideoSamplerExtraArgs</sub>, <sub>WanVideoSamplerFromSettings</sub>, <sub>WanVideoSamplerSettings</sub>, <sub>WanVideoSamplerv2</sub>, <sub>WanVideoScheduler</sub>, <sub>WanVideoSchedulerv2</sub>, <sub>WanVideoSetAttentionModeOverride</sub>, <sub>WanVideoSetBlockSwap</sub>, <sub>WanVideoSetLoRAs</sub>, <sub>WanVideoSetRadialAttention</sub>, <sub>WanVideoSigmaToStep</sub>, <sub>WanVideoSLG</sub>, <sub>WanVideoSVIProEmbeds</sub>, <sub>WanVideoTeaCache</sub>, <sub>WanVideoTextEmbedBridge</sub>, <sub>WanVideoTextEncode</sub>, <sub>WanVideoTextEncodeCached</sub>, <sub>WanVideoTextEncodeSingle</sub>, <sub>WanVideoTextImageEncode</sub>, <sub>WanVideoTinyVAELoader</sub>, <sub>WanVideoTorchCompileSettings</sub>, <sub>WanVideoUltraVicoSettings</sub>, <sub>WanVideoUni3C_ControlnetLoader</sub>, <sub>WanVideoUni3C_embeds</sub>, <sub>WanVideoUniAnimateDWPoseDetector</sub>, <sub>WanVideoUniAnimatePoseInput</sub>, <sub>WanVideoUniLumosEmbeds</sub>, <sub>WanVideoVACEEncode</sub>, <sub>WanVideoVACEModelSelect</sub>, <sub>WanVideoVACEStartToEndFrame</sub>, <sub>WanVideoVAELoader</sub>, <sub>WanVideoVRAMManagement</sub>, <sub>WanVideoWanDrawWanMoveTracks</sub>, <sub>Wav2VecModelLoader</sub>, <sub>WhisperModelLoader</sub>
</details>
...
**Stars**: `6.6k` | **Created at**: `2025-06-01` | **Last updated**: `2026-09-12`


The world's first open-source multimodal creative assistant  This is a substitute for Canva and Manus that prioritizes privacy and is usable locally.
# TOP 11 - 15

<details><summary>Star History for TOP 11 - 15</summary><a href="https://api.star-history.com/svg?repos=Osmantic/ODS,cubiq/ComfyUI_IPAdapter_plus,wiltodelta/remove-ai-watermarks,ATH-MaaS/ComfyUI-Copilot,mcmonkeyprojects/SwarmUI&type=Date"><img src="https://api.star-history.com/svg?repos=Osmantic/ODS,cubiq/ComfyUI_IPAdapter_plus,wiltodelta/remove-ai-watermarks,ATH-MaaS/ComfyUI-Copilot,mcmonkeyprojects/SwarmUI&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `6.4k` | **Created at**: `2026-02-09` | **Last updated**: `2026-09-12`


Turn your PC, Mac, or Linux box into an AI server.  LLM inference, chat UI, voice, agents, workflows, RAG, and image generation.

## 12. cubiq/ComfyUI_IPAdapter_plus
...
**Stars**: `6.1k` | **Created at**: `2023-08-30` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
## 13. wiltodelta/remove-ai-watermarks
...
**Stars**: `5.5k` | **Created at**: `2026-03-25` | **Last updated**: `2026-09-12`
...
**Stars**: `5.5k` | **Created at**: `2025-02-14` | **Last updated**: `2026-09-11`
...
**Stars**: `4.5k` | **Created at**: `2024-06-21` | **Last updated**: `2026-09-11` | **Tags**: `Integration`


SwarmUI (formerly StableSwarmUI), A Modular Stable Diffusion Web-User-Interface, with an emphasis on making powertools easily accessible, high performance, and extensibility.
# TOP 16 - 20

<details><summary>Star History for TOP 16 - 20</summary><a href="https://api.star-history.com/svg?repos=comfyanonymous/ComfyUI_examples,Fannovel16/comfyui_controlnet_aux,Lightricks/ComfyUI-LTXVideo,city96/ComfyUI-GGUF,nunchux-ai/nunchaku&type=Date"><img src="https://api.star-history.com/svg?repos=comfyanonymous/ComfyUI_examples,Fannovel16/comfyui_controlnet_aux,Lightricks/ComfyUI-LTXVideo,city96/ComfyUI-GGUF,nunchux-ai/nunchaku&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `4.5k` | **Created at**: `2023-01-30` | **Last updated**: `2026-09-12` | **Tags**: `Workflow Examples`


Examples of ComfyUI workflows

## 17. Fannovel16/comfyui_controlnet_aux
...
**Stars**: `4.2k` | **Created at**: `2023-08-17` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
<details><summary>Included Nodes (65)</summary>
 ...
 - <sub>TEED_Preprocessor</sub>, <sub>[TEEDPreprocessor](node_examples/TEEDPreprocessor.md)</sub>, <sub>[TilePreprocessor](node_examples/TilePreprocessor.md)</sub>, <sub>TTPlanet_TileGF_Preprocessor</sub>, <sub>TTPlanet_TileSimple_Preprocessor</sub>
...
## 18. Lightricks/ComfyUI-LTXVideo
...
**Stars**: `4.0k` | **Created at**: `2024-08-15` | **Last updated**: `2026-09-12` | **Tags**: `Custom Nodes`
...
**Stars**: `3.9k` | **Created at**: `2024-01-05` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes` `3D`
...
## 22. Kosinkadink/ComfyUI-AnimateDiff-Evolved
...
**Stars**: `3.5k` | **Created at**: `2023-08-14` | **Last updated**: `2026-09-12` | **Tags**: `Custom Nodes`
...
## 24. ltdrdata/ComfyUI-Impact-Pack
...
**Stars**: `3.3k` | **Created at**: `2023-03-30` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
**Stars**: `3.3k` | **Created at**: `2023-09-28` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
<details><summary>Included Nodes (261)</summary>
 ...
 - <sub>DecodeAndSaveVideo</sub>, <sub>DifferentialDiffusionAdvanced</sub>, <sub>DiffusionModelLoaderKJ</sub>, <sub>DiffusionModelSelector</sub>, <sub>DiTBlockLoraLoader</sub>, <sub>DownloadAndLoadCLIPSeg</sub>, <sub>DrawInstanceDiffusionTracking</sub>, <sub>DrawMaskOnImage</sub>, <sub>DummyOut</sub>
...
<details><summary>Star History for TOP 26 - 30</summary><a href="https://api.star-history.com/svg?repos=pythongosssss/ComfyUI-Custom-Scripts,chflame163/ComfyUI_LayerStyle,hero8152/Infinite-Canvas,nunchux-ai/ComfyUI-nunchaku,numz/ComfyUI-SeedVR2_VideoUpscaler&type=Date"><img src="https://api.star-history.com/svg?repos=pythongosssss/ComfyUI-Custom-Scripts,chflame163/ComfyUI_LayerStyle,hero8152/Infinite-Canvas,nunchux-ai/ComfyUI-nunchaku,numz/ComfyUI-SeedVR2_VideoUpscaler&type=Date" alt="Star History Chart" width="500"></a></details>


## 26. pythongosssss/ComfyUI-Custom-Scripts
...
**Stars**: `3.2k` | **Created at**: `2023-03-06` | **Last updated**: `2026-09-12` | **Tags**: `Custom Nodes` `Management`
...
**Stars**: `3.1k` | **Created at**: `2026-05-11` | **Last updated**: `2026-09-12`


Supports comfyui/API calls/modelscope calls

## 29. nunchux-ai/ComfyUI-nunchaku
...
**Stars**: `2.9k` | **Created at**: `2025-03-12` | **Last updated**: `2026-09-11`


ComfyUI Plugin of Nunchaku

## 30. numz/ComfyUI-SeedVR2_VideoUpscaler
...
**Stars**: `2.8k` | **Created at**: `2025-06-20` | **Last updated**: `2026-09-11`
...
<details><summary>Star History for TOP 31 - 35</summary><a href="https://api.star-history.com/svg?repos=FurkanGozukara/Stable-Diffusion,yolain/ComfyUI-Easy-Use,PowerHouseMan/ComfyUI-AdvancedLivePortrait,heshengtao/super-agent-party,kijai/ComfyUI-HunyuanVideoWrapper&type=Date"><img src="https://api.star-history.com/svg?repos=FurkanGozukara/Stable-Diffusion,yolain/ComfyUI-Easy-Use,PowerHouseMan/ComfyUI-AdvancedLivePortrait,heshengtao/super-agent-party,kijai/ComfyUI-HunyuanVideoWrapper&type=Date" alt="Star History Chart" width="500"></a></details>


## 31. FurkanGozukara/Stable-Diffusion
...
**Stars**: `2.8k` | **Created at**: `2023-05-01` | **Last updated**: `2026-09-11` | **Tags**: `Tutorials`
...
**Stars**: `2.7k` | **Created at**: `2024-07-31` | **Last updated**: `2026-09-09` | **Tags**: `Custom Nodes` `Video`
...
## 34. heshengtao/super-agent-party
...
**Stars**: `2.6k` | **Created at**: `2024-12-03` | **Last updated**: `2026-09-09`
...
<details><summary>Star History for TOP 36 - 40</summary><a href="https://api.star-history.com/svg?repos=AIGODLIKE/AIGODLIKE-ComfyUI-Translation,pydn/ComfyUI-to-Python-Extension,heshengtao/comfyui_LLM_party,Comfy-Org/desktop,6174/comflowyspace&type=Date"><img src="https://api.star-history.com/svg?repos=AIGODLIKE/AIGODLIKE-ComfyUI-Translation,pydn/ComfyUI-to-Python-Extension,heshengtao/comfyui_LLM_party,Comfy-Org/desktop,6174/comflowyspace&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `2.5k` | **Created at**: `2023-08-15` | **Last updated**: `2026-09-11` | **Tags**: `Translation`
...
**Stars**: `2.4k` | **Created at**: `2023-07-30` | **Last updated**: `2026-09-04` | **Tags**: `Integration`


A powerful tool that translates ComfyUI workflows into executable Python code.

## 38. heshengtao/comfyui_LLM_party
...
**Stars**: `2.4k` | **Created at**: `2024-04-13` | **Last updated**: `2026-09-12` | **Tags**: `Custom Nodes` `LLM`
...
<details><summary>Included Nodes (211)</summary>
 ...
 - <sub>GeocodeTool</sub>, <sub>get_string</sub>, <sub>GGUFLoader</sub>, <sub>github_tool</sub>, <sub>google_loader</sub>, <sub>google_tool</sub>, <sub>got_ocr</sub>, <sub>gpt_sovits</sub>, <sub>graph_md_to_html</sub>
 ...
 - <sub>list_append</sub>, <sub>list_append_plus</sub>, <sub>list_extend</sub>, <sub>list_extend_plus</sub>, <sub>listen_audio</sub>, <sub>litellm_loader</sub>, <sub>LLavaLoader</sub>, <sub>LLM</sub>, <sub>LLM_api_loader</sub>, <sub>LLM_local</sub>, <sub>LLM_local_loader</sub>, <sub>load_bool</sub>, <sub>load_ebd</sub>, <sub>load_excel</sub>, <sub>load_file</sub>, <sub>load_file_folder</sub>, <sub>load_float</sub>, <sub>load_img_path</sub>, <sub>load_int</sub>, <sub>load_keyword</sub>, <sub>load_llm_lora</sub>, <sub>load_memo</sub>, <sub>load_name</sub>, <sub>load_openai_ebd</sub>, <sub>load_persona</sub>, <sub>load_redis_memo</sub>, <sub>load_SQL_memo</sub>, <sub>load_url</sub>, <sub>load_wikipedia</sub>, <sub>LorapathLoader</sub>, <sub>Lorebook</sub>
 ...
 - <sub>TavernPresetLoader</sub>, <sub>TavernStyleLLM</sub>, <sub>text2json</sub>, <sub>text2parameters</sub>, <sub>text_iterator</sub>, <sub>text_writing</sub>, <sub>time_sleep</sub>, <sub>time_tool</sub>, <sub>tool_combine</sub>, <sub>tool_combine_plus</sub>, <sub>translate_persona</sub>, <sub>txt2srt</sub>
...
**Stars**: `2.4k` | **Created at**: `2024-08-13` | **Last updated**: `2026-09-11`


[ARCHIVED] Superseded by https://github.com/Comfy-Org/Comfy-Desktop

## 40. 6174/comflowyspace
...
**Stars**: `2.3k` | **Created at**: `2023-11-25` | **Last updated**: `2026-09-11` | **Tags**: `Integration`
...
<details><summary>Star History for TOP 41 - 45</summary><a href="https://api.star-history.com/svg?repos=yawiii/ComfyUI-Prompt-Assistant,kijai/ComfyUI-SUPIR,kijai/ComfyUI-LivePortraitKJ,yolain/ComfyUI-Yolain-Workflows,zombieyang/sd-ppp&type=Date"><img src="https://api.star-history.com/svg?repos=yawiii/ComfyUI-Prompt-Assistant,kijai/ComfyUI-SUPIR,kijai/ComfyUI-LivePortraitKJ,yolain/ComfyUI-Yolain-Workflows,zombieyang/sd-ppp&type=Date" alt="Star History Chart" width="500"></a></details>


## 41. yawiii/ComfyUI-Prompt-Assistant
...
**Stars**: `2.3k` | **Created at**: `2025-06-06` | **Last updated**: `2026-09-12`
...
**Stars**: `2.3k` | **Created at**: `2024-02-28` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
## 43. kijai/ComfyUI-LivePortraitKJ
...
**Stars**: `2.2k` | **Created at**: `2024-07-04` | **Last updated**: `2026-09-12`
...
## 44. yolain/ComfyUI-Yolain-Workflows
...
**Stars**: `2.2k` | **Created at**: `2024-05-13` | **Last updated**: `2026-09-11` | **Tags**: `Workflow Examples`
...
**Stars**: `2.2k` | **Created at**: `2024-03-29` | **Last updated**: `2026-09-12`
...
<details><summary>Star History for TOP 46 - 50</summary><a href="https://api.star-history.com/svg?repos=1038lab/ComfyUI-RMBG,mut-ex/gligen-gui,WhatDreamsCost/WhatDreamsCost-ComfyUI,Comfy-Org/ComfyUI_frontend,crystian/ComfyUI-Crystools&type=Date"><img src="https://api.star-history.com/svg?repos=1038lab/ComfyUI-RMBG,mut-ex/gligen-gui,WhatDreamsCost/WhatDreamsCost-ComfyUI,Comfy-Org/ComfyUI_frontend,crystian/ComfyUI-Crystools&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `2.1k` | **Created at**: `2024-11-14` | **Last updated**: `2026-09-11`
...
## 48. WhatDreamsCost/WhatDreamsCost-ComfyUI
...
**Stars**: `2.0k` | **Created at**: `2026-03-20` | **Last updated**: `2026-09-11`


LTX Director and a variety of other custom ComfyUI nodes and workflows

## 49. Comfy-Org/ComfyUI_frontend
...
**Stars**: `2.0k` | **Created at**: `2024-06-13` | **Last updated**: `2026-09-12` | **Tags**: `Core`


Official front-end implementation of ComfyUI

## 50. crystian/ComfyUI-Crystools
...
**Stars**: `2.0k` | **Created at**: `2023-12-23` | **Last updated**: `2026-09-11` | **Tags**: `Management`
...
<details><summary>Star History for TOP 51 - 55</summary><a href="https://api.star-history.com/svg?repos=siliconflow/onediff,flybirdxx/ComfyUI-Qwen-TTS,Tavris1/ComfyUI-Easy-Install,MixLabPro/comfyui-mixlab-nodes,cubiq/ComfyUI_InstantID&type=Date"><img src="https://api.star-history.com/svg?repos=siliconflow/onediff,flybirdxx/ComfyUI-Qwen-TTS,Tavris1/ComfyUI-Easy-Install,MixLabPro/comfyui-mixlab-nodes,cubiq/ComfyUI_InstantID&type=Date" alt="Star History Chart" width="500"></a></details>


## 51. siliconflow/onediff
...
**Stars**: `2.0k` | **Created at**: `2022-09-21` | **Last updated**: `2026-09-09` | **Tags**: `Acceleration`


OneDiff: An out-of-the-box acceleration library for diffusion models.

## 52. flybirdxx/ComfyUI-Qwen-TTS
...
**Stars**: `1.9k` | **Created at**: `2026-01-22` | **Last updated**: `2026-09-11`


A Simple Implementation of Qwen3-TTS's ComfyUI

## 53. Tavris1/ComfyUI-Easy-Install
...
**Stars**: `1.9k` | **Created at**: `2024-10-16` | **Last updated**: `2026-09-12`
...
## 54. MixLabPro/comfyui-mixlab-nodes
...
**Stars**: `1.9k` | **Created at**: `2023-10-18` | **Last updated**: `2026-09-11`


Workflow-to-APP、ScreenShare&FloatingVideo、GPT & 3D、SpeechRecognition&TTS

## 55. cubiq/ComfyUI_InstantID
...
**Stars**: `1.8k` | **Created at**: `2024-01-27` | **Last updated**: `2026-09-09` | **Tags**: `Custom Nodes`
...
<details><summary>Star History for TOP 56 - 60</summary><a href="https://api.star-history.com/svg?repos=WASasquatch/was-node-suite-comfyui,Kosinkadink/ComfyUI-VideoHelperSuite,ZHO-ZHO-ZHO/comfyui-portrait-master-zh-cn,huchenlei/ComfyUI-layerdiffuse,jau123/MeiGen-AI-Design-MCP&type=Date"><img src="https://api.star-history.com/svg?repos=WASasquatch/was-node-suite-comfyui,Kosinkadink/ComfyUI-VideoHelperSuite,ZHO-ZHO-ZHO/comfyui-portrait-master-zh-cn,huchenlei/ComfyUI-layerdiffuse,jau123/MeiGen-AI-Design-MCP&type=Date" alt="Star History Chart" width="500"></a></details>


## 56. WASasquatch/was-node-suite-comfyui
...
**Stars**: `1.8k` | **Created at**: `2023-03-24` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`


WAS-NS Reborn; Tools for image processing, filters, masking, text, logic, numbers, latents, files, 3D scenes, and animation.

## 57. Kosinkadink/ComfyUI-VideoHelperSuite
...
**Stars**: `1.8k` | **Created at**: `2023-09-23` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes` `Video`
...
## 58. ZHO-ZHO-ZHO/comfyui-portrait-master-zh-cn
...
**Stars**: `1.8k` | **Created at**: `2023-12-15` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes` `Chinese Language`
...
## 59. huchenlei/ComfyUI-layerdiffuse
...
**Stars**: `1.8k` | **Created at**: `2024-03-02` | **Last updated**: `2026-09-08` | **Tags**: `Custom Nodes`
...
**Stars**: `1.7k` | **Created at**: `2026-02-07` | **Last updated**: `2026-09-11`
...
<details><summary>Star History for TOP 61 - 65</summary><a href="https://api.star-history.com/svg?repos=kijai/ComfyUI-Florence2,NimaNzrii/comfyui-photoshop,XLabs-AI/x-flux-comfyui,kijai/ComfyUI-FramePackWrapper,YanWenKun/ComfyUI-Docker&type=Date"><img src="https://api.star-history.com/svg?repos=kijai/ComfyUI-Florence2,NimaNzrii/comfyui-photoshop,XLabs-AI/x-flux-comfyui,kijai/ComfyUI-FramePackWrapper,YanWenKun/ComfyUI-Docker&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `1.7k` | **Created at**: `2024-06-19` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
**Stars**: `1.7k` | **Created at**: `2023-12-09` | **Last updated**: `2026-09-11` | **Tags**: `Integration`
...
<details><summary>Included Nodes (10)</summary>
 ...
 - <sub>ClipPass</sub>
 - <sub>modelPass</sub>
 - <sub>PhotoshopConnection</sub>, <sub>PhotoshopToComfyUI</sub>
 - <sub>SendToPhotoshop</sub>
...
**Stars**: `1.7k` | **Created at**: `2024-08-12` | **Last updated**: `2026-09-12` | **Tags**: `Custom Nodes`
...
## 64. kijai/ComfyUI-FramePackWrapper
...
**Stars**: `1.7k` | **Created at**: `2025-04-17` | **Last updated**: `2026-09-04`


None

## 65. YanWenKun/ComfyUI-Docker
...
**Stars**: `1.6k` | **Created at**: `2023-03-17` | **Last updated**: `2026-09-11`


🐳Dockerfile for 🎨ComfyUI. | 容器镜像与启动脚本
# TOP 66 - 70

<details><summary>Star History for TOP 66 - 70</summary><a href="https://api.star-history.com/svg?repos=AIMixer/ComfyUI_MiniMaxH3_Director,AHEKOT/ComfyUI_VNCCS,Enemyx-net/VibeVoice-ComfyUI,ssitu/ComfyUI_UltimateSDUpscale,kijai/ComfyUI-CogVideoXWrapper&type=Date"><img src="https://api.star-history.com/svg?repos=AIMixer/ComfyUI_MiniMaxH3_Director,AHEKOT/ComfyUI_VNCCS,Enemyx-net/VibeVoice-ComfyUI,ssitu/ComfyUI_UltimateSDUpscale,kijai/ComfyUI-CogVideoXWrapper&type=Date" alt="Star History Chart" width="500"></a></details>


## 66. AIMixer/ComfyUI_MiniMaxH3_Director
...
**Stars**: `1.6k` | **Created at**: `2026-08-04` | **Last updated**: `2026-09-12`


Multi-segment MiniMax H3 Director for official ComfyUI MiniMax-H3

## 67. AHEKOT/ComfyUI_VNCCS
...
**Stars**: `1.6k` | **Created at**: `2025-09-27` | **Last updated**: `2026-09-11`
...
**Stars**: `1.6k` | **Created at**: `2025-08-27` | **Last updated**: `2026-09-11`
...
**Stars**: `1.6k` | **Created at**: `2023-05-16` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`


ComfyUI nodes for the Ultimate Stable Diffusion Upscale script by Coyote-A.
<details><summary>Included Nodes (4)</summary>

 - [UltimateSDUpscale🌟](node_examples/UltimateSDUpscale.md), <sub>UltimateSDUpscaleCustomSample</sub>, <sub>UltimateSDUpscaleGuider</sub>, <sub>[UltimateSDUpscaleNoUpscale](node_examples/UltimateSDUpscaleNoUpscale.md)</sub>
</details>
...
**Stars**: `1.6k` | **Created at**: `2024-08-05` | **Last updated**: `2026-08-30` | **Tags**: `Custom Nodes`
...
<details><summary>Star History for TOP 71 - 75</summary><a href="https://api.star-history.com/svg?repos=AIGODLIKE/ComfyUI-BlenderAI-node,16131zzzzzzzz/EveryoneNobel,BennyKok/comfyui-deploy,AlekPet/ComfyUI_Custom_Nodes_AlekPet,zhulu111/ComfyUI_Bxb&type=Date"><img src="https://api.star-history.com/svg?repos=AIGODLIKE/ComfyUI-BlenderAI-node,16131zzzzzzzz/EveryoneNobel,BennyKok/comfyui-deploy,AlekPet/ComfyUI_Custom_Nodes_AlekPet,zhulu111/ComfyUI_Bxb&type=Date" alt="Star History Chart" width="500"></a></details>


## 71. AIGODLIKE/ComfyUI-BlenderAI-node
...
**Stars**: `1.5k` | **Created at**: `2023-04-24` | **Last updated**: `2026-09-07` | **Tags**: `Integration` `3D`
...
**Stars**: `1.5k` | **Created at**: `2024-10-20` | **Last updated**: `2026-09-09`
...
**Stars**: `1.5k` | **Created at**: `2023-12-08` | **Last updated**: `2026-09-07` | **Tags**: `Custom Nodes` `Integration`
...
**Stars**: `1.5k` | **Created at**: `2023-05-10` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`


Custom nodes that extend the capabilities of Comfyui

## 75. zhulu111/ComfyUI_Bxb
...
**Stars**: `1.5k` | **Created at**: `2024-05-18` | **Last updated**: `2026-09-10`
...
<details><summary>Star History for TOP 76 - 80</summary><a href="https://api.star-history.com/svg?repos=jags111/efficiency-nodes-comfyui,willmiao/ComfyUI-Lora-Manager,11cafe/comfyui-workspace-manager,ZHO-ZHO-ZHO/ComfyUI-InstantID,logtd/ComfyUI-Fluxtapoz&type=Date"><img src="https://api.star-history.com/svg?repos=jags111/efficiency-nodes-comfyui,willmiao/ComfyUI-Lora-Manager,11cafe/comfyui-workspace-manager,ZHO-ZHO-ZHO/ComfyUI-InstantID,logtd/ComfyUI-Fluxtapoz&type=Date" alt="Star History Chart" width="500"></a></details>


## 76. jags111/efficiency-nodes-comfyui
...
**Stars**: `1.5k` | **Created at**: `2023-08-31` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
<details><summary>Included Nodes (40)</summary>
 ...
 - <sub>[NNLatentUpscale](node_examples/NNLatentUpscale.md)</sub>, <sub>NNlLatentUpscale</sub>, <sub>[Noise Control Script](node_examples/Noise_Control_Script.md)</sub>
...
## 77. willmiao/ComfyUI-Lora-Manager
...
**Stars**: `1.5k` | **Created at**: `2025-01-27` | **Last updated**: `2026-09-11`
...
## 78. 11cafe/comfyui-workspace-manager
...
**Stars**: `1.4k` | **Created at**: `2023-12-02` | **Last updated**: `2026-09-11` | **Tags**: `Management`
...
## 79. ZHO-ZHO-ZHO/ComfyUI-InstantID
...
**Stars**: `1.4k` | **Created at**: `2024-01-22` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes` `Chinese Language`
...
<details><summary>Star History for TOP 81 - 85</summary><a href="https://api.star-history.com/svg?repos=scraed/LanPaint,fofr/cog-face-to-many,jtydhr88/ComfyUI-qwenmultiangle,Gourieff/ComfyUI-ReActor,zanllp/infinite-image-browsing&type=Date"><img src="https://api.star-history.com/svg?repos=scraed/LanPaint,fofr/cog-face-to-many,jtydhr88/ComfyUI-qwenmultiangle,Gourieff/ComfyUI-ReActor,zanllp/infinite-image-browsing&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `1.4k` | **Created at**: `2025-02-27` | **Last updated**: `2026-09-11`
...
**Stars**: `1.4k` | **Created at**: `2024-03-05` | **Last updated**: `2026-09-01` | **Tags**: `Workflow Examples`


Turn any face into a video game character, pixel art, claymation, 3D or toy

## 83. jtydhr88/ComfyUI-qwenmultiangle
...
**Stars**: `1.4k` | **Created at**: `2026-01-08` | **Last updated**: `2026-09-12`
...
<details><summary>Included Nodes (2)</summary>
 ...
 - <sub>QwenMultiangleCameraNode</sub>, <sub>QwenMultiangleCameraTranslateNode</sub>
</details>


## 84. Gourieff/ComfyUI-ReActor
...
**Stars**: `1.4k` | **Created at**: `2025-01-17` | **Last updated**: `2026-09-11`
...
<details><summary>Included Nodes (16)</summary>
 ...
 - <sub>[ReActorBuildFaceModel](node_examples/ReActorBuildFaceModel.md)</sub>, <sub>ReActorFaceBoost</sub>, <sub>ReActorFaceSimilarity</sub>, [ReActorFaceSwap🌟](node_examples/ReActorFaceSwap.md), <sub>[ReActorFaceSwapOpt](node_examples/ReActorFaceSwapOpt.md)</sub>, <sub>ReActorImageDublicator</sub>, <sub>[ReActorLoadFaceModel](node_examples/ReActorLoadFaceModel.md)</sub>, <sub>ReActorMakeFaceModelBatch</sub>, <sub>[ReActorMaskHelper](node_examples/ReActorMaskHelper.md)</sub>, <sub>[ReActorOptions](node_examples/ReActorOptions.md)</sub>, <sub>[ReActorRestoreFace](node_examples/ReActorRestoreFace.md)</sub>, <sub>ReActorRestoreFaceAdvanced</sub>, <sub>[ReActorSaveFaceModel](node_examples/ReActorSaveFaceModel.md)</sub>, <sub>ReActorSetWeight</sub>, <sub>ReActorUnload</sub>
</details>


## 85. zanllp/infinite-image-browsing
...
**Stars**: `1.3k` | **Created at**: `2023-03-07` | **Last updated**: `2026-09-10`
...
<details><summary>Star History for TOP 86 - 90</summary><a href="https://api.star-history.com/svg?repos=nerdyrodent/AVeryComfyNerd,Suzie1/ComfyUI_Comfyroll_CustomNodes,wyrde/wyrde-comfyui-workflows,florestefano1975/comfyui-portrait-master,Acly/comfyui-inpaint-nodes&type=Date"><img src="https://api.star-history.com/svg?repos=nerdyrodent/AVeryComfyNerd,Suzie1/ComfyUI_Comfyroll_CustomNodes,wyrde/wyrde-comfyui-workflows,florestefano1975/comfyui-portrait-master,Acly/comfyui-inpaint-nodes&type=Date" alt="Star History Chart" width="500"></a></details>


## 86. nerdyrodent/AVeryComfyNerd
...
**Stars**: `1.3k` | **Created at**: `2023-08-17` | **Last updated**: `2026-09-07` | **Tags**: `Resources`


ComfyUI related stuff and things

## 87. Suzie1/ComfyUI_Comfyroll_CustomNodes
...
**Stars**: `1.3k` | **Created at**: `2023-04-03` | **Last updated**: `2026-09-09` | **Tags**: `Workflow Examples`


some wyrde workflows for comfyUI

## 89. florestefano1975/comfyui-portrait-master
...
**Stars**: `1.2k` | **Created at**: `2023-12-13` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
**Stars**: `1.2k` | **Created at**: `2024-01-24` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
<details><summary>Star History for TOP 91 - 95</summary><a href="https://api.star-history.com/svg?repos=pythongosssss/ComfyUI-WD14-Tagger,chengzeyi/Comfy-WaveSpeed,mcmonkeyprojects/sd-dynamic-thresholding,kijai/ComfyUI-segment-anything-2,6174/comflowy&type=Date"><img src="https://api.star-history.com/svg?repos=pythongosssss/ComfyUI-WD14-Tagger,chengzeyi/Comfy-WaveSpeed,mcmonkeyprojects/sd-dynamic-thresholding,kijai/ComfyUI-segment-anything-2,6174/comflowy&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `1.2k` | **Created at**: `2023-05-11` | **Last updated**: `2026-09-11` | **Tags**: `Custom Nodes`
...
**Stars**: `1.2k` | **Created at**: `2023-01-27` | **Last updated**: `2026-09-04` | **Tags**: `Custom Nodes`
...
## 94. kijai/ComfyUI-segment-anything-2
...
**Stars**: `1.2k` | **Created at**: `2024-07-30` | **Last updated**: `2026-09-08` | **Tags**: `Custom Nodes`
...
**Stars**: `1.2k` | **Created at**: `2023-11-20` | **Last updated**: `2026-09-10` | **Tags**: `Website`


Unleash endless possibilities with ComfyUI and Stable Diffusion, committed to crafting refined AI-Gen tools and cultivating a vibrant community for both developers and users. 
# TOP 96 - 100

<details><summary>Star History for TOP 96 - 100</summary><a href="https://api.star-history.com/svg?repos=diodiogod/TTS-Audio-Suite,cubiq/ComfyUI_essentials,602387193c/ComfyUI-wiki,kijai/ComfyUI-FluxTrainer,kijai/ComfyUI-IC-Light&type=Date"><img src="https://api.star-history.com/svg?repos=diodiogod/TTS-Audio-Suite,cubiq/ComfyUI_essentials,602387193c/ComfyUI-wiki,kijai/ComfyUI-FluxTrainer,kijai/ComfyUI-IC-Light&type=Date" alt="Star History Chart" width="500"></a></details>
...
**Stars**: `1.2k` | **Created at**: `2025-08-06` | **Last updated**: `2026-09-12`
...
**Stars**: `1.2k` | **Created at**: `2023-09-20` | **Last updated**: `2026-09-12` | **Tags**: `Custom Nodes`
...
**Stars**: `1.2k` | **Created at**: `2024-03-18` | **Last updated**: `2026-09-11` | **Tags**: `Resources`
...
**Stars**: `1.2k` | **Created at**: `2024-08-15` | **Last updated**: `2026-09-06`
...
**Stars**: `1.2k` | **Created at**: `2024-05-09` | **Last updated**: `2026-08-28` | **Tags**: `Custom Nodes`
...
### Automatically updated on: 2026-09-12 03:44:34 UTC
